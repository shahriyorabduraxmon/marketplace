...
class Left<L, R> extends Either<L, R> {
  ...
  @override B fold<B>(B Function(L l) ifLeft, B Function(R r) ifRight) => ifLeft(value);
}
...
class Right<L, R> extends Either<L, R> {
  ...
  @override B fold<B>(B Function(L l) ifLeft, B Function(R r) ifRight) => ifRight(value);
}
